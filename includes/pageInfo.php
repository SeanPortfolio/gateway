...
$tags_arr['webfont_headings'] = '
    <style>h1, h2, .h1 .h2, h2 a, .btn, header .booking-btn, .heroshot__caption__text, #primary-nav, .heading, .control-label, .sitemap{
            ...
            <div class="hidden-xs col-sm-12">
                <div class="room-info-sticker">
                    ...
                    <div class="price-sticker-bot">
                        <div class="price-quicklink btn" $hiddePrice><span class="from">FROM</span> <span class="pricetag">$dollar</span><span class="num-p">$from_price</span><span class="currency_text">$currencyText</span></span></div>
                    </div>
                </div>
            </div>
        </div>
