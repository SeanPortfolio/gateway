				...
				<div class="grid--row-content text-center">
				 ...
				 <div class="room-info">
					...
					<div class="price-sticker">
						<div class="price-quicklink" $hiddePrice>FROM <span class="pricetag">{$currencyIconView}</span><span class="num-p">$price</span><span class="currency_text">$currencyText</span></span></div>
					</div>
				</div>
				<div class="view-deatils text-center">
					<a class="btn btn-quicklink" href="{$accom['full_url']}">{$ctaAccommDetailsBtnText }</a>
				</div>
				</div>
